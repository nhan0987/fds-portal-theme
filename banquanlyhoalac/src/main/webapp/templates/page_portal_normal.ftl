...
<body class="${css_class} mBody page-theme">
	...
	<script type="text/javascript">		
		$(document).ready(function() {
			...
			$(".header_login .logo > img").attr("src","o/banquanlyhoalac/images/logo-login-motcua.png");
			$(".dvc-theme .header_login .logo > img").attr("src","o/banquanlyhoalac/images/logo-login-dvc.png");
